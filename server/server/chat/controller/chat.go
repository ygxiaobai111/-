...
import (
	...
	"github.com/ygxiaobai111/Three_Kingdoms_of_Longning/server/server/chat/logic"
	"github.com/ygxiaobai111/Three_Kingdoms_of_Longning/server/server/chat/middleware"
...
func (c *chatController) history(req *net.WsMsgReq, rsp *net.WsMsgRsp) {
	...
	if reqObj.Type == 0 {
		//世界聊天的消息
		rspObj.Msgs = c.worldGroup.History()
